...
// تم تصحيح مسار الاستيراد ليتوافق مع موقع الملف (src/components/models/hero_models/Room.jsx)
import { correctPath } from "../../../utils/pathUtils";

export function Room(props) {
  const screensRef = useRef();

  // تطبيق correctPath على مسار ملف GLB
  const { nodes, materials } = useGLTF(correctPath("/models/optimized-room.glb"));
  
  // تطبيق correctPath على مسار ملف Texture (الكساء)
  const matcapTexture = useTexture(correctPath("/images/textures/mat1.png"));
...
      {/* Removed EffectComposer and SelectiveBloom for performance */}
      <mesh
...
// تطبيق correctPath على دالة التحميل المسبق
useGLTF.preload(correctPath("/models/optimized-room.glb"));